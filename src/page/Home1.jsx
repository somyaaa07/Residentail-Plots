...
body { background: #ffffff; color: #111111; -webkit-font-smoothing: antialiased; overflow-x: hidden; }
:root {
  --navy: #111111;
  --navy-light: #333333;
  --navy-pale: #f0f0f0;
  --navy-muted: rgba(17,17,17,0.45);
  --green: #ba2429;
  --green-light: #d42b31;
  --green-pale: #fdf0f0;
  --white: #ffffff;
  ...
  --text-dim: rgba(17,17,17,0.35);
  --serif: 'Cinzel', serif;
  --display: 'Cormorant Garamond', serif;
  --sans: 'DM Sans', sans-serif;
  --nav-h: 72px;
  --shadow-sm: 0 2px 12px rgba(17,17,17,0.08);
  --shadow-md: 0 8px 32px rgba(17,17,17,0.12);
...
::selection { background: #ba2429; color: #fff; }
::-webkit-scrollbar { width: 4px; }
::-webkit-scrollbar-track { background: var(--off-white); }
::-webkit-scrollbar-thumb { background: #ba2429; border-radius: 2px; }
...
function Eyebrow({ label, light = false }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
      <div style={{ width: 28, height: 2, background: light ? "rgba(255,255,255,0.6)" : "#ba2429", borderRadius: 1, flexShrink: 0 }} />
      <span style={{
        fontFamily: "var(--sans)", fontSize: "0.58rem", letterSpacing: "0.26em",
        textTransform: "uppercase", fontWeight: 600,
        color: light ? "rgba(255,255,255,0.7)" : "#ba2429"
      }}>{label}</span>
    </div>
  );
}
...
function GreenBtn({ children, onClick, outline = false, small = false, fullWidth = false }) {
  ...
  return (
    <button
      ...
      style={{
        background: outline ? "transparent" : (hov ? "#8f1a1e" : "#ba2429"),
        border: outline ? `2px solid ${hov ? "#ba2429" : "#111111"}` : "2px solid transparent",
        color: outline ? (hov ? "#ba2429" : "#111111") : "#fff",
    ...
    <>
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
            <img
              src="/logo.svg"
              alt="Ace Estate Residential Plots"
              ...
              {links.map(l => (
                <a key={l} href={`#${l.toLowerCase().replace(" ", "-")}`}
                  style={{
                    ...
                    letterSpacing: ".06em", color: scrolled ? "#111111" : "#fff",
                    textDecoration: "none", transition: "color .2s", whiteSpace: "nowrap"
                  }}
                  onMouseEnter={e => e.currentTarget.style.color = "#ba2429"}
                  onMouseLeave={e => e.currentTarget.style.color = scrolled ? "#111111" : "#fff"}
                >{l}</a>
              ))}
            </div>
          )}
            ...
            {!bp.isDesktop && (
              <button
                ...
                style={{
                  ...
                  background: open ? "#111111" : (scrolled ? "#111111" : "rgba(255,255,255,0.18)"),
                  backdropFilter: "blur(8px)",
                  border: `1.5px solid ${open ? "#111111" : (scrolled ? "#111111" : "rgba(255,255,255,0.35)")}`,
                  borderRadius: 50,
      ...
      {!bp.isDesktop && (
        <div style={{
          ...
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: "linear-gradient(to right, #111111, #ba2429)" }} />
          {links.map((l, i) => (
            <a key={l} href={`#${l.toLowerCase().replace(" ", "-")}`} onClick={() => setOpen(false)}
              style={{
                fontFamily: "var(--serif)",
                fontSize: bp.isTablet ? "2.2rem" : bp.isXs ? "1.6rem" : "1.9rem",
                fontWeight: 500, color: "#111111", textDecoration: "none",
                opacity: open ? 1 : 0,
                transform: open ? "translateY(0)" : "translateY(14px)",
                transition: `opacity .4s ${0.04 + i * 0.06}s ease, transform .4s ${0.04 + i * 0.06}s ease`,
                display: "flex", alignItems: "center", gap: 10,
              }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#ba2429", display: "inline-block", flexShrink: 0 }} />
              {l}
            </a>
          ))}
      ...
      <div style={{ position: "absolute", bottom: bp.isXs ? "1.25rem" : "1.75rem", left: "50%", transform: "translateX(-50%)", display: "flex", gap: 8, zIndex: 5 }}>
        {[0, 1, 2].map(i => (
          <button key={i} onClick={() => setSlide(i)}
            style={{ width: i === slide ? 24 : 7, height: 7, borderRadius: 4, background: i === slide ? "#ba2429" : "rgba(255,255,255,0.4)", border: "none", cursor: "pointer", padding: 0, transition: "all .4s", minWidth: 7 }} />
        ))}
      </div>
        ...
        <div style={{
          ...
          <div style={{ order: bp.isDesktop ? 1 : 2, position: "relative" }}>
            <div style={{
              ...
              />
              <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(17,17,17,0.55) 0%, transparent 55%)" }} />
          ...
          <div style={{ order: bp.isDesktop ? 2 : 1 }}>
            <h2 style={{
              ...
              fontWeight: 600, color: "#111111", lineHeight: 1.06, marginBottom: "1.5rem"
            }}>
            ...
            <p style={{ fontFamily: "var(--sans)", fontSize: bp.isXs ? ".8rem" : ".86rem", color: "var(--text-muted)", lineHeight: 1.9, marginBottom: "1rem" }}>
              Experience the perfect blend of modern living, prime location, and excellent investment potential. Ideally situated in Sector 22D, Greater Noida, along the rapidly developing Yamuna Expressway, Ace Estate Residential Plots offers a unique opportunity to build your dream home in a well-planned, future-ready neighbourhood.
            </p>
...
function QuoteBanner() {
  ...
  return (
    <div ref={ref} style={{ position: "relative", overflow: "hidden", background: "#fff" }}>
      <div style={{ height: 4, background: "linear-gradient(to right, #111111 0%, #111111 50%, #ba2429 100%)" }} />
        ...
        <div style={{
          ...
          <div style={{ opacity: vis ? 1 : 0, transform: vis ? "none" : "translateY(20px)", transition: "opacity 1s ease, transform 1s ease", position: "relative" }}>
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1.5rem" }}>
                <div style={{ width: 3, height: 36, background: "#111111", borderRadius: 2, flexShrink: 0 }} />
                <span style={{ fontFamily: "var(--sans)", fontSize: ".56rem", letterSpacing: ".28em", textTransform: "uppercase", color: "#111111", fontWeight: 700 }}>Investment Insight</span>
              </div>
              <blockquote style={{ fontFamily: "var(--display)", fontStyle: "italic", fontSize: bp.isXs ? "1.6rem" : bp.isMobile ? "1.9rem" : "clamp(2.1rem,3.2vw,3rem)", fontWeight: 600, color: "#111111", lineHeight: 1.2, marginBottom: "1.5rem" }}>
                "The Yamuna Expressway<br /><span style={{ color: "#111111" }}>is not a location —</span><br />it is a legacy."
              </blockquote>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 2, opacity: vis ? 1 : 0, transition: "opacity .8s .2s ease" }}>
            {stats.map((s, i) => (
              <div key={i} style={{
                background: i === 0 ? "#111111" : i === 1 ? "#fdf0f0" : i === 2 ? "#fdf0f0" : "#f0f0f0",
                ...
                <div style={{ fontFamily: "var(--display)", fontStyle: "italic", fontSize: bp.isXs ? "1.8rem" : "2.4rem", fontWeight: 700, color: i === 0 ? "#fff" : "#ba2429", lineHeight: 1, marginBottom: ".4rem" }}>{s.val}</div>
                <div style={{ fontFamily: "var(--sans)", fontSize: bp.isXs ? ".58rem" : ".65rem", fontWeight: 700, letterSpacing: ".06em", textTransform: "uppercase", color: i === 0 ? "rgba(255,255,255,0.9)" : "#111111", marginBottom: ".15rem" }}>{s.label}</div>
        ...
        <Reveal>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: "2rem" }}>
            <div>
              ...
              <h2 style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.6rem" : "clamp(1.8rem,4vw,3rem)", fontWeight: 600, color: "#111111", lineHeight: 1.1 }}>Life at Ace Estate Residential Plots</h2>
            </div>
...
function AmenitiesSection() {
  ...
  const categories = [
    { label: "Green & Open", color: "#ba2429", bg: "#fdf0f0", items: [
    ...
    { label: "Recreation", color: "#111111", bg: "#f0f0f0", items: [
    ...
    { label: "Infrastructure", color: "#ba2429", bg: "#fdf0f0", items: [
    ...
    { label: "Safety", color: "#111111", bg: "#f0f0f0", items: [
        ...
        <Reveal>
          <div style={{ display: "grid", gridTemplateColumns: bp.isDesktop ? "1fr 1fr" : "1fr", gap: "1.5rem", marginBottom: "2.5rem", alignItems: "end" }}>
            <div>
              ...
              <h2 style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.6rem" : "clamp(1.8rem,4vw,3.2rem)", fontWeight: 600, color: "#111111", lineHeight: 1.05 }}>
          ...
          {cat.items.map((item, i) => (
            <div key={`${activeTab}-${i}`}
              ...
              <div style={{ padding: bp.isXs ? "1.25rem" : "1.75rem" }}>
                <h4 style={{ fontFamily: "var(--serif)", fontSize: "1rem", fontWeight: 600, color: "#111111", marginBottom: ".6rem", lineHeight: 1.2 }}>{item.title}</h4>
        ...
        <Reveal delay={0.2}>
          <div style={{ marginTop: "2rem", display: "grid", gridTemplateColumns: bp.isXs ? "1fr 1fr" : "repeat(4, 1fr)", gap: 2 }}>
            {[
              ...
              <div key={i} style={{ background: i === 0 ? "#111111" : "#fff", border: "2px solid var(--border)", padding: bp.isXs ? "1.1rem" : "1.4rem", display: "flex", flexDirection: "column", gap: 4, borderRadius: 5 }}>
                <div style={{ fontFamily: "var(--display)", fontStyle: "italic", fontSize: bp.isXs ? "1.5rem" : "1.9rem", fontWeight: 700, color: i === 0 ? "#fff" : "#ba2429", lineHeight: 1 }}>{s.num}</div>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: `0 ${hPad(bp)}`, position: "relative", zIndex: 1 }}>
        <Reveal>
          <div style={{ display: "flex", flexDirection: "column", marginBottom: bp.isMobile ? "1.75rem" : "2.5rem", gap: ".5rem" }}>
            ...
            <h2 style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.6rem" : "clamp(1.8rem,4vw,3.2rem)", fontWeight: 600, color: "#111111", lineHeight: 1.1 }}>Choose Your Plot Size</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: `repeat(${plots.length}, 1fr)`, gap: 3, marginBottom: 3 }}>
          {plots.map((pl, i) => (
            <button key={i} onClick={() => setActive(i)} onMouseEnter={() => setHov(i)} onMouseLeave={() => setHov(null)}
              style={{ background: active === i ? pl.tagColor : (hov === i ? "rgba(17,17,17,0.06)" : "#fff"), border: `2px solid ${active === i ? pl.tagColor : "rgba(17,17,17,0.12)"}`, borderRadius: 5, padding: bp.isXs ? "9px 4px" : "12px 8px", cursor: "pointer", transition: "all .3s ease", display: "flex", flexDirection: "column", alignItems: "center", gap: 3 }}>
              <span style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? ".75rem" : bp.isMobile ? ".85rem" : ".95rem", fontWeight: 600, color: active === i ? "#fff" : "#111111", transition: "color .3s", textAlign: "center", lineHeight: 1.2 }}>{pl.title}</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: bp.isMobile ? "1fr" : "1fr 1.35fr", gap: 3, borderRadius: 8, overflow: "hidden", opacity: vis ? 1 : 0, transform: vis ? "none" : "translateY(20px)", transition: "opacity .8s ease, transform .8s ease", boxShadow: "0 16px 50px rgba(0,0,0,0.12)" }}>
          ...
          <div style={{ background: "#fffafa", padding: bp.isXs ? "1.5rem" : "2.25rem", borderRight: bp.isMobile ? "none" : "2px solid rgba(17,17,17,0.08)" }}>
            ...
            <h3 style={{ fontFamily: "var(--display)", fontStyle: "italic", fontSize: bp.isXs ? "2rem" : "2.8rem", fontWeight: 600, color: "#111111", lineHeight: 1, marginBottom: ".2rem" }}>{p.title}</h3>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: ".75rem", marginBottom: "1.5rem" }}>
              {[["🧭", "Facing", p.facing], ["🛣️", "Road Width", p.road]].map(([icon, label, val]) => (
                <div key={label} style={{ background: "#f5f0f0", borderRadius: 7, padding: "10px 12px", border: "1.5px solid rgba(17,17,17,0.08)" }}>
                  ...
                  <div style={{ fontFamily: "var(--sans)", fontSize: bp.isXs ? ".68rem" : ".72rem", color: "#111111", fontWeight: 600, lineHeight: 1.3 }}>{val}</div>
                </div>
              ))}
            </div>
            ...
            <div style={{ borderTop: "2px solid rgba(17,17,17,0.08)", paddingTop: "1.25rem" }}>
          ...
          <div style={{ position: "relative", minHeight: bp.isMobile ? 220 : 0, overflow: "hidden" }}>
            {plots.map((pl, i) => (
              <div key={i} style={{ position: "absolute", inset: 0, opacity: active === i ? 1 : 0, transition: "opacity .7s ease" }}>
                ...
                <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(17,17,17,0.38) 0%, transparent 60%)" }} />
              </div>
            ))}
            <div style={{ position: "absolute", top: 14, right: 14, background: "rgba(255,250,250,0.93)", backdropFilter: "blur(10px)", border: `2px solid ${p.tagColor}44`, borderRadius: 6, padding: "7px 12px" }}>
...
function LocationAdvantageSection({ onEnquire }) {
  ...
  return (
    <section id="location-advantage" ref={ref} style={{ padding: `${vPad(bp)} 0`, background: "#111111", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: "linear-gradient(to right, #ba2429, #d42b31)" }} />
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: `0 ${hPad(bp)}`, position: "relative", zIndex: 1 }}>
        <Reveal>
          <div style={{ display: "grid", gridTemplateColumns: bp.isDesktop ? "1fr 1fr" : "1fr", gap: "2rem", marginBottom: bp.isMobile ? "2rem" : "3.5rem", alignItems: "end" }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                <div style={{ width: 28, height: 2, background: "#ba2429", borderRadius: 1 }} />
                <span style={{ fontFamily: "var(--sans)", fontSize: "0.58rem", letterSpacing: "0.26em", textTransform: "uppercase", fontWeight: 600, color: "#ba2429" }}>Location Advantage</span>
              </div>
              <h2 style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.7rem" : bp.isMobile ? "2.2rem" : "clamp(2.4rem,4vw,4rem)", fontWeight: 600, color: "#fff", lineHeight: 1.06 }}>
                Surrounded by<br /><span style={{ color: "#ba2429" }}>India's Biggest</span><br />Investments.
              </h2>
            </div>
            <div>
...
function LocationSection() {
  ...
  const landmarkGroups = [
    { label: "Aviation & Transit", color: "#ba2429", items: [
    ...
    { label: "Entertainment", color: "#111111", items: [
    ...
    { label: "Education & Biz", color: "#ba2429", items: [
        ...
        <Reveal>
          <div style={{ display: "grid", gridTemplateColumns: bp.isDesktop ? "1fr 1fr" : "1fr", gap: "2rem", marginBottom: "2.5rem", alignItems: "end" }}>
            <div>
              ...
              <h2 style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.6rem" : "clamp(1.8rem,4vw,3rem)", fontWeight: 600, color: "#111111", lineHeight: 1.1 }}>India's Growth Corridor</h2>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: ".875rem" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 9, background: "#f0f0f0", borderRadius: 6, padding: "9px 14px", width: "fit-content", maxWidth: "100%" }}>
                <span style={{ fontSize: "1rem", flexShrink: 0 }}>📍</span>
                <span style={{ fontFamily: "var(--sans)", fontSize: bp.isXs ? ".62rem" : ".68rem", fontWeight: 600, color: "#111111", lineHeight: 1.4 }}>Plot TS-01B, Sector 22D, Yamuna Expressway, Greater Noida — 201308</span>
              </div>
            </div>
          </div>
        </Reveal>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <div style={{ background: "#fff", border: "2px solid var(--border)", borderRadius: 7, overflow: "hidden", flex: 1 }}>
              ...
              {activeG.items.map((lm, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: bp.isXs ? ".875rem 1.1rem" : "1rem 1.25rem", borderBottom: i < activeG.items.length - 1 ? "1px solid var(--border)" : "none", transition: "background .2s", gap: 8 }}
                  ...
                  <span style={{ fontFamily: "var(--sans)", fontSize: bp.isXs ? ".72rem" : ".76rem", fontWeight: 500, color: "#111111", lineHeight: 1.4 }}>{lm.name}</span>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 }}>
              {[{ val: "0.5 km", label: "From Expressway" }, { val: "15 Min", label: "To Jewar Airport" }].map((s, i) => (
                <div key={i} style={{ background: i === 0 ? "#111111" : "var(--off-white)", border: "2px solid var(--border)", borderRadius: 5, padding: bp.isXs ? "1rem" : "1.1rem 1.2rem" }}>
                  <div style={{ fontFamily: "var(--display)", fontStyle: "italic", fontSize: bp.isXs ? "1.35rem" : "1.5rem", fontWeight: 700, color: i === 0 ? "#fff" : "#ba2429", lineHeight: 1, marginBottom: 3 }}>{s.val}</div>
        ...
        <Reveal>
          ...
          <div style={{ display: "grid", gridTemplateColumns: bp.isXs ? "1fr" : bp.isMobile ? "1fr" : bp.isTablet ? "1fr 1fr" : "repeat(3, 1fr)", gap: bp.isMobile ? "1rem" : "1.5rem" }}>
            {[
              ...
              { icon: "✉️", title: "Email", lines: ["info@aceestate.com"] },
            ].map((c, i) => (
              <div key={i} style={{ display: "flex", gap: ".875rem", alignItems: "flex-start", background: "#fff", border: "2px solid var(--border)", borderRadius: 8, padding: bp.isXs ? "1.25rem" : "1.5rem 1.75rem" }}>
                <div style={{ width: 40, height: 40, background: "#f0f0f0", borderRadius: 7, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem", flexShrink: 0 }}>{c.icon}</div>
                <div>
                  <div style={{ fontFamily: "var(--sans)", fontSize: ".54rem", letterSpacing: ".18em", textTransform: "uppercase", color: "#ba2429", fontWeight: 700, marginBottom: 6 }}>{c.title}</div>
                  {c.lines.map((line, j) => <div key={j} style={{ fontFamily: "var(--sans)", fontSize: bp.isXs ? ".76rem" : ".8rem", color: "#111111", fontWeight: 600, lineHeight: 1.65 }}>{line}</div>)}
                </div>
              </div>
            ))}
          </div>
...
function Footer() {
  ...
  const links = {
    ...
    "Company": ["About Ace Estate Group", "Careers", "Press"],
    "Legal": ["Privacy Policy", "Terms", "YEIDA Info"],
  };

  return (
    <footer style={{ background: "#0a0a0a", padding: bp.isXs ? "40px 1rem 28px" : `60px ${hPad(bp)} 36px` }}>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: bp.isXs ? "1fr 1fr" : bp.isMobile ? "1fr 1fr" : bp.isDesktop ? "2fr 1fr 1fr 1fr" : "1fr 1fr", gap: bp.isXs ? "1.5rem 1rem" : "2.5rem", marginBottom: "3rem" }}>
          <div style={{ gridColumn: bp.isXs ? "1/3" : "auto" }}>
            <div style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.1rem" : "1.2rem", fontWeight: 700, color: "#fff", marginBottom: ".875rem", letterSpacing: ".04em" }}>Ace Estate Residential Plots</div>
          ...
          {Object.entries(links).map(([group, items]) => (
            <div key={group}>
              <div style={{ fontFamily: "var(--sans)", fontSize: ".54rem", letterSpacing: ".2em", textTransform: "uppercase", color: "#ba2429", fontWeight: 700, marginBottom: "1rem" }}>{group}</div>
...
function Disclaimer() {
  const bp = useBreakpoint();
  return (
    <div style={{ background: "#0a0a0a", borderTop: "1px solid rgba(255,255,255,0.05)", padding: bp.isXs ? "1.5rem 1rem" : `2rem ${hPad(bp)}` }}>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(17,17,17,0.7)", backdropFilter: "blur(12px)", display: "flex", alignItems: "center", justifyContent: "center", padding: bp.isXs ? "0.75rem" : "1rem", animation: "fadeIn .25s ease" }}>
      <div onClick={e => e.stopPropagation()}
        style={{ background: "#fff", width: "100%", maxWidth: 460, borderRadius: 12, overflow: "hidden", boxShadow: "0 36px 72px rgba(0,0,0,0.3)", maxHeight: "92svh", overflowY: "auto" }}>
        <div style={{ height: 4, background: "linear-gradient(to right, #111111, #ba2429)" }} />
        <div style={{ padding: bp.isXs ? "1.375rem" : "2.25rem" }}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "1.5rem" }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <Eyebrow label="Enquire Now" />
              <h3 style={{ fontFamily: "var(--serif)", fontSize: bp.isXs ? "1.4rem" : "2rem", fontWeight: 600, color: "#111111" }}>Register Interest</h3>
...
function AutoPopup({ open, onClose }) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 200, background: "rgba(17,17,17,0.65)", backdropFilter: "blur(16px)", display: "flex", alignItems: "center", justifyContent: "center", padding: bp.isXs ? ".75rem" : "1rem", animation: "fadeIn .5s ease" }}>
      <div onClick={e => e.stopPropagation()}
        style={{ background: "#fff", width: "100%", maxWidth: bp.isMobile ? 360 : 680, borderRadius: 12, overflow: "hidden", display: "grid", gridTemplateColumns: bp.isMobile ? "1fr" : "1fr 1fr", boxShadow: "0 36px 72px rgba(0,0,0,0.4)", maxHeight: "90svh", overflowY: "auto" }}>
        {!bp.isMobile && (
          <div style={{ position: "relative", minHeight: 360, overflow: "hidden" }}>
            ...
            <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(17,17,17,0.92) 0%, rgba(17,17,17,0.28) 60%)" }} />
        ...
        <div style={{ padding: bp.isXs ? "1.75rem 1.375rem" : "2.25rem", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "1.25rem" }}>
            {bp.isMobile && <h3 style={{ fontFamily: "var(--serif)", fontSize: "1.6rem", fontWeight: 600, color: "#111111", flex: 1, minWidth: 0 }}>Early Access Plots</h3>}
            {!bp.isMobile && <div />}
            <button onClick={onClose} style={{ background: "var(--off-white)", border: "none", width: 30, height: 30, borderRadius: "50%", cursor: "pointer", fontSize: ".95rem", display: "flex", alignItems: "center", justifyContent: "center", color: "#111111", flexShrink: 0, marginLeft: 8 }}>×</button>
          </div>
...
function StickyBottomCTA({ onEnquire }) {
  ...
  return (
    <div className="sticky-bar" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 90, display: "grid", gridTemplateColumns: "1fr 1fr", background: "#fff", borderTop: "2px solid var(--border)", boxShadow: "0 -4px 20px rgba(0,0,0,0.1)", animation: "fadeUp .4s ease" }}>
      <a href="tel:+919205974843" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 7, padding: "14px", textDecoration: "none", borderRight: "2px solid var(--border)", color: "#111111", fontFamily: "var(--sans)", fontSize: ".62rem", fontWeight: 600, letterSpacing: ".07em", textTransform: "uppercase" }}>
        📞 Call Now
      </a>
      <button onClick={onEnquire} style={{ background: "#ba2429", border: "none", color: "#fff", fontFamily: "var(--sans)", fontSize: ".62rem", fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", padding: "14px", cursor: "pointer" }}>
        Enquire Now
      </button>
    </div>
  );
...
function Sidebar({ onEnquire }) {
  ...
  return (
    <div style={{
      ...
      scrollbarWidth: "thin",
      scrollbarColor: "#ba2429 transparent",
    }}>
      <div style={{ borderBottom: "2px solid var(--border)", paddingBottom: "1.25rem", marginBottom: "1.25rem" }}>
        <div style={{ fontFamily: "var(--sans)", fontSize: ".52rem", letterSpacing: ".18em", textTransform: "uppercase", color: "#ba2429", fontWeight: 700, marginBottom: ".4rem" }}>Plot Sizes</div>
        <div style={{ fontFamily: "var(--serif)", fontSize: "1.2rem", fontWeight: 600, color: "#111111", lineHeight: 1.2 }}>150 – 500 sq.yd</div>
      ...
      <div style={{ borderTop: "2px solid var(--border)", paddingTop: "1.25rem", marginTop: "1.5rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontFamily: "var(--sans)", fontSize: ".74rem", fontWeight: 600, color: "#111111" }}>+91 9205974843</div>
